...
Nevertheless, I am fairly confident that this page is a good basis for all standard data tasks (data management, visualizations, regressions) and that >80% of all of those tasks are covered by the packages and functions which are on this page. 
