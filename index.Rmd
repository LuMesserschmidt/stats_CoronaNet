...
Welcome to this introductory **R Intro** tutorial that shall show you how to use the CoronaNet data appropriately. The website builds on works formally designed by Benedikt Fritz. Luca Messerschmidt adjusted the content and added - with support by Cindy Cheng - Videos and CoronaNet examples. The following paragraphs will get you familiar with R and hopefully make you full-fledged R users in no time. Please be ware that this tutorial is only a specific add-on to other great and insightful R-Tutorials (listed below)
